...
ECHO CFLAGS = /c /TP /EHs /W3 /WX /Gs /std:c++17 >> Makefile.constants
...
ECHO INCLSSL = /I"%BLDDIR%ssl\%BLDPLAT%\include" /I"%BLDDIR%libsslwrapper\include" >> Makefile.constants
...
ECHO LIBSSLWRAPPER = "%BLDDIR%libsslwrapper\src\%BLDPLAT%\sslwrapper.lib" >> Makefile.constants
