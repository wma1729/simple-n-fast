 ...
 *
 * @throws snf::ssl::net::exception if the trust store could not be created or
 ...
 *
 * @throws snf::net::ssl::exception if the certificate could not be added
 *         to the trust store.
 */
void
 ...
 *
 * @throws snf::net::ssl::exception if the CRL could not be added to the
